CREATE TABLE IF NOT EXISTS `login`.`users` (
 `user_id` int(11) unsigned NOT NULL COMMENT 'auto incrementing user_id of each user, unique index',
  ...
  `user_oauth_uid` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_oauth_provider` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_oauth_token` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
 PRIMARY KEY (`user_id`),
